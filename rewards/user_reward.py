"""
https://gitlab.aicrowd.com/aicrowd/challenges/citylearn-challenge-2022/citylearn-2022-starter-kit/-/blob/d44a6b73fa2dff0ff5bb8ac470f31f505f2682e2/rewards/user_reward.py
"""
...
class UserReward(RewardFunction):
    def __init__(self, agent_count,
        ...
        if observation is None:
            ...
            electricity_consumption = [
                o[electricity_consumption_index] for o in observation]
            carbon_emission = [
                o[carbon_emission_index] *
                o[electricity_consumption_index] for o in observation]
            electricity_price =[
                o[electricity_pricing_index] *
                o[electricity_consumption_index] for o in observation]
    ...
    def calculate(self) -> List[float]:
        ...
        Notes
        -----
        This function is called internally in the environment's
        :meth:`citylearn.CityLearnEnv.step` function.
        """
